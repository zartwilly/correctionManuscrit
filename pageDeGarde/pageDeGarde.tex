...
\newcommand{\jurynameB}{Christian LAFOREST}
\newcommand{\juryadressB}{Professeur, Universit\'e Clermont Auvergne (LIMOS-ISIMA)}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (President)
\newcommand{\jurynameC}{Pascal BERTHOM\'E}
\newcommand{\juryadressC}{Professeur, INSA Centre Val de Loire(LIFO) }
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°4 (Examinateur) / Member n°4 (President)
\newcommand{\jurynameD}{Daniele GARDY}
\newcommand{\juryadressD}{Professeur, Universit\'e de Versailles (DAVID)}
...
\begin{textblock}{10.3}(5.4,3)
	...
	\begin{flushright}
		...
		\normalsize {Th\`ese de doctorat de l'Université Paris-Saclay} \\
		pr\'epar\'e \`a \PhDworkingplace \\ \bigskip
		\vfill
		Ecole doctorale n$^{\circ}$\ecodocnum ~\ecodoctitle ~(\ecodocacro)  \\
		
		\small{Sp\'ecialité de doctorat: \PhDspeciality} \bigskip %% Spécialité 
		\vfill  
