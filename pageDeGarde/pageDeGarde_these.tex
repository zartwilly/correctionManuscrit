...
\newcommand{\PhDTitle}{Algorithmes de graphes pour la d\'ecouverte de la topologie d'un r\'eseau \'energ\'etique par la connaissance de ses flots} 	%% Titre de la thèse / Thesis title
...
\newcommand{\ecodocnum}{27} 																%% Numéro de l'école doctorale / Doctoral School number
\newcommand{\PhDspeciality}{Programmation : Mod\`eles, Algorithmes, Langages, Architecture} 										%% Spécialité de doctorat / Speciality 
...
\newcommand{\defensedate}{02/10/2018} 															%% Date de soutenance / Date of defense
...
\newcommand{\jurynameA}{Dani\`ele GARDY}
\newcommand{\juryadressA}{Professeur, Universit\'e de Versailles (DAVID)}
\newcommand{\juryroleA}{Pr\'esidente}

%%% Membre n°2 (Rapporteur) / Member n°2 (President)
\newcommand{\jurynameB}{Pascal BARTHOM\'E}
\newcommand{\juryadressB}{Professeur, INSA centre Val de Loire (LIFO)}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (President)
\newcommand{\jurynameC}{Christian LAFOREST}
\newcommand{\juryadressC}{Prof\'esseur, Universit\'e Clermont Auvergne (LIMOS-ISIMA)}
\newcommand{\juryroleC}{Rapporteur}


%%% Membre n°4 (Examinateur) / Member n°4 (President)
\newcommand{\jurynameD}{Sandrine VIAL}
\newcommand{\juryadressD}{Maitre de conf\'erences, Universit\'e de Versailles (DAVID)}
